...
Goal: Select the option that MAXIMIZES the user's chance of getting the job. 
...
Education: {self.applicant.highest_education.degree if self.applicant.highest_education else 'N/A'} at {self.applicant.highest_education.institution if self.applicant.highest_education else 'N/A'}
Skills: {self.applicant.get_skills_string(30)}
Current Experience: {self.applicant.experience[0].title if self.applicant.experience else 'N/A'} at {self.applicant.experience[0].company if self.applicant.experience else 'N/A'}
"""
