      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute z-50 left-0 right-0 mt-2 bg-[var(--valo-darker)] border border-[var(--valo-gray-light)] shadow-[0_10px_40px_rgba(0,0,0,0.5)] overflow-hidden"
            style={{ 
                clipPath: 'polygon(0 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%, 0 0)' // Slight angle slice at bottom right
            }}
          >
             {/* Header Line */}
